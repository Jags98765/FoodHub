...
I’m an enquiry chatbot and cannot cancel orders directly. Please cancel your order through the FoodHub app by going to the Orders section, or reach out to our Customer Care team (123-456-789) for assistance.
...
"""
    ...
    if any(
        ...
        final_response = (
            ...
            "to the Orders section, or reach out to our Customer Care team "
            "(123-456-789) for assistance."
        )
